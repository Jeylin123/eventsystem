                ...
                <div class="clearfix padding-top-40" >
                    ...
                    <div class="col-md-8 single-property-content prp-style-1 ">
                        ...
                        <div class="alert px-0 mx-0" style="background-color: #FDC600;">
                            ...
                            <p style="color: gray;">test tset test tset test tset test tset test tset test tset </p>
                        </div>
                        <br><br>
                                        ...
                                        <li>
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-8 blg-entry">
                                                ...
                                                <span class="property-price"><?php echo "P"." ".$t->price.".00";?></span>
                                                 ...
                                                 <?php if(!$bought){?>
                                                <a href="<?php echo site_url();?>/event/cEvent/buyTicket/<?php echo $t->ticket_type_id;?>/<?php echo $e->event_id;?>"><button  class="navbar-btn nav-button wow bounceInRight login animated" >Buy</button></a>
                                                <?php }?>
                                                </span>                                            <?php }?>  
                                                <!--<span>&nbsp;&nbsp;&nbsp; Sold:
                                                 <?php $ts->cnt?>                                                   
